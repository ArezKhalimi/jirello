    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(null=True, upload_to=b'user_profile_images', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('kind', models.CharField(default=b'T', max_length=2, choices=[('E', 'Epic'), ('S', 'Story'), ('T', 'Task'), ('B', 'Bug'), ('t', 'SubTask'), ('b', 'StoryBug')])),
